...
export type PhoneScalarWhereWithAggregatesInput = {
  ...
  userId?: Prisma.IntWithAggregatesFilter<"Phone"> | number
}
...
export type PhoneOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "phone" | "userId", ExtArgs["result"]["phone"]>
...
export interface PhoneFieldRefs {
  ...
  readonly userId: Prisma.FieldRef<"Phone", 'Int'>
}
